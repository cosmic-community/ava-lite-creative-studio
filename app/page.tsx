        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/services" className="btn btn-primary bg-white text-primary hover:bg-gray-100">
                Our Services
              </Link>
              <Link href="/case-studies" className="btn btn-secondary bg-secondary text-white hover:bg-gray-800">
                View Our Work
              </Link>
            </div>
          </div>
